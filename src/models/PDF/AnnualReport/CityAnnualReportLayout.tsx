...
export default function CityAnnualReportLayout(
    ...
    return {
        ...
        content: [
            ...
            {
                text: `Звіт станиці ${annualReport.city?.name} за ${new Date(annualReport.date).getUTCFullYear()} рік`,
                style: "header",
            },
            {
                layout: {
                ...
                table: {
                    ...
                    body: [
                        ...
                        [
                            ...
                            {
                                text: `${cityLegalStatuses[annualReport.newCityLegalStatusType]}`,
                                colSpan: 2,
                            },
                            "",
                        ],
                ...
                table: {
                    ...
                    body: [
                        ...
                        [
                            {
                                colSpan: 3,
                                text: `${annualReport.listProperty === null ? "Інформація відсутня" : annualReport.listProperty}`,
                        ...
                        [
                            {
                                colSpan: 3,
                                text: `${annualReport.improvementNeeds === null ? "Інформація відсутня" : annualReport.improvementNeeds}`,
                            },
                        ],
                    ],
                },
