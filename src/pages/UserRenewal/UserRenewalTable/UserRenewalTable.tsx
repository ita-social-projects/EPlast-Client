...
const UserRenewalTable = () => {
    ...
    const getRenewals = async () => {
        setLoading(true);
        const data: UserRenewalTableData[] =
            await userRenewalsApi.getUserRenewalsTableData(searchedData, page, pageSize);
    ...
    const getUser = async () => {
        ...
        setcurrentCityAdmin(
            (await UserApi.getUserProfileById(user.nameid, user.nameid)).data.user.cityId);
