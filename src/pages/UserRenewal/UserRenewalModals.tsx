...
const showUserRenewalModal = () => {
  return Modal.confirm({
    title: <div style={{ textAlign: "justify" }}>
      <h4>Доступ до вашого аккаунту обмежено, оскільки ви є колишнім членом пласту.
        Ви можете надіслати запит на відновлення статусу.</h4>
    </div>,
    icon: <ExclamationCircleOutlined />,
