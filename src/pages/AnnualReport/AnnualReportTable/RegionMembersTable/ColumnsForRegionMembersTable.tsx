...
const columns = [
  ...
  },
  {
    ...
    render: (numberOfUnatstvaSupporters: any) => {
      return numberOfUnatstvaSupporters ? (
        <p>{numberOfUnatstvaSupporters}</p>
      ) : (
        ""
      );
    },
  ...
  },
  {
    ...
    render: (numberOfUnatstvaProspectors: any) => {
      return numberOfUnatstvaProspectors ? (
        <p>{numberOfUnatstvaProspectors}</p>
      ) : (
        ""
      );
    },
  ...
  },
  {
    ...
    render: (numberOfUnatstvaSkobVirlyts: any) => {
      return numberOfUnatstvaSkobVirlyts ? (
        <p>{numberOfUnatstvaSkobVirlyts}</p>
      ) : (
        ""
      );
    },
  ...
  },
  {
    ...
    render: (numberOfSeniorPlastynSupporters: any) => {
      return numberOfSeniorPlastynSupporters ? (
        <p>{numberOfSeniorPlastynSupporters}</p>
      ) : (
        ""
      );
    },
  ...
  },
  {
    ...
    render: (numberOfSeniorPlastynMembers: any) => {
      return numberOfSeniorPlastynMembers ? (
        <p>{numberOfSeniorPlastynMembers}</p>
      ) : (
        ""
      );
    },
  ...
  },
  {
    ...
    render: (numberOfSeigneurSupporters: any) => {
      return numberOfSeigneurSupporters ? (
        <p>{numberOfSeigneurSupporters}</p>
      ) : (
        ""
      );
    },
  ...
  },
  {
    ...
    render: (numberOfTeacherAdministrators: any) => {
      return numberOfTeacherAdministrators ? (
        <p>{numberOfTeacherAdministrators}</p>
      ) : (
        ""
      );
    },
  ...
  },
  {
    ...
    render: (numberOfPlastpryiatMembers: any) => {
      return numberOfPlastpryiatMembers ? (
        <p>{numberOfPlastpryiatMembers}</p>
      ) : (
        ""
      );
    },
