        ...
        <>
          ...
          <Form onFinish={() => history.goBack()} className="annualreport-form">
            ...
            <Row className="card__wrap--outer">
              ...
              >
                <Card className="flexible">
                  <Title level={4}>Побажання до КБ УСП: </Title>
                  <Text className="clubAnnualReportInformationText">
                    ...
                    <Col xs={24} sm={24} md={18} lg={18} xl={18}>
                      ...
                      {clubHead ? (
                        <>
                          ...
                          >
                            {clubAnnualReport.phoneNumber?.replace(" ", "") ==
                            ""
                              ? "немає"
                              : clubAnnualReport.phoneNumber}
                          </Form.Item>
                          <Form.Item
                            label={<Text strong={true}>Електронна пошта</Text>}
                          >
                            {clubAnnualReport.email?.replace(" ", "") == ""
                              ? "немає"
                              : clubAnnualReport.email}
                          </Form.Item>
                        </>
                      ) : (
                      ...
                      >
                        {clubAnnualReport.clubURL?.replace(" ", "") == ""
                          ? "немає"
                          : clubAnnualReport.clubURL}
                      </Form.Item>
                    </Col>
