...
function EditTerms() {
  ...
  const checkTextLength = () => {
    terms.termsText.length > 45000
      ? messageCheckTextLength()
      : messageForUsers();
  };
  ...
  function messageCheckTextLength() {
    return Modal.confirm({
      title:
        "Довжина тексту політики конфіденційності перевищує 40 000 символів. Будь ласка, скоротіть довжину тексту.",
  ...
  function messageForUsers() {
    return Modal.info({
      title:
        "Політку конфіденційності змінено. Всім користувачам надіслано повідомлення.",
      icon: <ExclamationCircleOutlined />,
      okText: "Зрозуміло",
      maskClosable: false,
      okType: "danger",
      ...
      <Card hoverable className="editTermsCard">
        ...
        <Form className="reactQuill">
          ...
          <Row className="editButtons" justify="center" gutter={[0, 6]}>
            ...
            <Col xs={24} sm={12}>
              <Button htmlType="submit" type="primary" onClick={submitChange}>
                Змінити
              </Button>
            </Col>
          </Row>
