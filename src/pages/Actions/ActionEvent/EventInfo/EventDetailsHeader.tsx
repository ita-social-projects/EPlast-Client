...
const renderContentMaxlength = (text: string): ReactNode => <Text className="event-data-input">{ extendedTitleTooltip(textMaxLengthDesc, text) }</Text>
...
const EventDetailsHeader = ({
    ...
    return (
        <Descriptions column = {{ xs: 1, sm: 2, md: 2, lg: 2, xxl: 3 }} layout = "horizontal" className = "descriptions" >
            <Descriptions.Item label = { renderLabel("Назва") } span={2}>{ renderContentMaxlength(eventName) }</Descriptions.Item>
            ...
            <Descriptions.Item label = { renderLabel("Призначена для") } span={3}>{ renderContent(forWhom) }</Descriptions.Item> 
