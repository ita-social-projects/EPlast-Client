...
const columns = [
  {
    ...
    sorter: true,//(a: any, b: any) => a.number - b.number,
  },
  {
    title: 'Перестороги',
  ...
  },
  {
    ...
    sorter: true,//(a: any, b: any) => a.userName.localeCompare(b.userName),
  ...
  },
  {
    ...
    sorter: true,//(a: any, b: any) => a.endDate.localeCompare(b.endDate),
    sortDirections: ['ascend', 'descend'] as SortOrder[],
  },
  {
    title: 'Подання від',
