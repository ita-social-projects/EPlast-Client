...
const DecisionTable = () => {
  ...
  const [data, setData] = useState<DecisionTableInfo[]>(
    Array<DecisionTableInfo>()
  );
  ...
  const fetchData = async () => {
    ...
    setLoading(true);
    const res: DecisionTableInfo[] = await decisionsApi.getAllDecisionsForTable(
      searchedData,
      page,
      pageSize
    );
